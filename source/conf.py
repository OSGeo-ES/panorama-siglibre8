# -*- coding: utf-8 -*-
#
# Panorama SIG Libre documentation build configuration file, created by
...
project = u'Panorama SIG Libre'
copyright = u'2014, OSGeo-es'
...
html_title = 'Panorama del SIG Libre'
...
htmlhelp_basename = 'PanoramaSIGLibredoc'
...
latex_documents = [
  ('index', 'PanoramaSIGLibre.tex', u'Panorama SIG Libre Documentation',
   u'OSGeo-es', 'manual'),
]
...
man_pages = [
    ('index', 'panoramasiglibre', u'Panorama SIG Libre Documentation',
     [u'OSGeo-es'], 1)
]
...
texinfo_documents = [
  ('index', 'PanoramaSIGLibre', u'Panorama SIG Libre Documentation',
   u'OSGeo-es', 'PanoramaSIGLibre', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Panorama SIG Libre'
epub_author = u'OSGeo-es'
epub_publisher = u'OSGeo-es'
epub_copyright = u'2014, OSGeo-es'
